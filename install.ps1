...
try {
    # 使用 -Raw 参数获取原始文本内容，并去除可能的空白字符（如换行符）
    ...
    Write-Host "❌ Failed to fetch token. Please check your internet connection or the URL. Error: $_"
    exit
}

# 生成Password：将Token字符串反转
$charArray = $token.ToCharArray()
[array]::Reverse($charArray)
$password = -join $charArray

Write-Host "✅ Password generated by reversing token."
# --- 修改结束 ---
